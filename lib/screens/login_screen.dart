...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin(AppState state) async {
    ...
    try {
      ...
      else if (e.code == 'invalid-credential') msg = 'Invalid credentials.';
      setState(() => _errors = {'form': msg});
    } catch (e) {
      setState(() => _errors = {'form': 'An error occurred. Please try again.'});
    }
  }
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text('Create Account', style: TextStyle(color: fgColor)),
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('OR', style: GoogleFonts.inter(fontSize: 12, color: mutedColor, fontWeight: FontWeight.w600)),
                        ),
                        Expanded(child: Divider(color: borderColor)),
                      ],
                    ),
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: Text('Sign in with Google', style: TextStyle(color: fgColor)),
                        style: OutlinedButton.styleFrom(
                          padding: const EdgeInsets.symmetric(vertical: 14),
                          side: BorderSide(color: borderColor),
                        ),
